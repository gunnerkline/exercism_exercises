...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        int bank_sum{ zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier) + garcia::bank_number_part(secret_modifier) };
    ...
    int assemble_code() {
        ...
        int total_mult{ total_blue * total_red };
